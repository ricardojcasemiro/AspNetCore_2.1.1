    ...
    public static class DbInitializer
    {
        public static void Seed(this ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Usuario>().HasData(
                new Usuario { Id = 1, Nome = "Ricardo Casemiro", Email = "ricardojcasemiro@gmail.com", Senha = "123456".Encrypt()},
                new Usuario { Id = 2, Nome = "Fabiano Nalin", Email = "nalin@fansoft.com.br", Senha = "78910".Encrypt() }
            );
        }
    }
}
